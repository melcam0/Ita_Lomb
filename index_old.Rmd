...
La seconda componente "legge" i dimessi/guariti e i morti. La guarigione è sia clinica (dimessi) che virologica (positivi divenatti negativi) il che rende la variabile un po' ingannevole

L'andamento nel tempo della seconda componente (o meglio dellla media mobile a 7 giorni - per "smorzare" le oscillazioni giornaliere ) oltre ad avere un ovvio ritardo sulla prima risente molto di quanto appena detto. Rappresenta quanto è stata forte (sempre tenendo conto di quanto appena detto) l'ondata.
