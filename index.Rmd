...
ggplot(data=S,aes(x=giorno,y=Dim.1,colour=mese,label=giorno))+ 
  ...
  ylab('MM (7gg) PC 1')+ theme(legend.position="bottom")
...
Andamento nel tempo della prima componente (o meglio dellla media mobile a 7 giorni - per "smorzare" le oscillazioni giornaliere ).\
